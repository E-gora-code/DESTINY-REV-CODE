package org.firstinspires.ftc.teamcode.teamcode.drivetrain.teamcode.pedroPathing;
 ...
 */
public class CustomRrivetrain extends Drivetrain {



    private final double MotorPower0;
    private final double MotorPower1;
    private final double MotorPower2;
    private final double MotorPower3;
    private final double MotorsScale;
    public customconsts constants;
    ...
    public CustomRrivetrain(HardwareMap hardwareMap, customconsts customconsts) {
        constants = customconsts;

        this.maxPowerScaling = customconsts.maxPower;

        this.motorCachingThreshold = customconsts.motorCachingThreshold;
        this.useBrakeModeInTeleOp = customconsts.useBrakeModeInTeleOp;

        voltageSensor = hardwareMap.voltageSensor.iterator().next();

        leftFront = hardwareMap.get(DcMotorEx.class, customconsts.leftFrontMotorName);
        leftRear = hardwareMap.get(DcMotorEx.class, customconsts.leftRearMotorName);
        rightRear = hardwareMap.get(DcMotorEx.class, customconsts.rightRearMotorName);
        rightFront = hardwareMap.get(DcMotorEx.class, customconsts.rightFrontMotorName);
        this.MotorPower0 = customconsts.MotorPower0;
        this.MotorPower1 = customconsts.MotorPower1;
        this.MotorPower2 = customconsts.MotorPower2;
        this.MotorPower3 = customconsts.MotorPower3;
        this.MotorsScale = customconsts.MotorsScale;
        ...
        Vector copiedFrontLeftVector = customconsts.frontLeftVector.normalize();
        vectors = new Vector[]{
    ...
    public CustomRrivetrain(double leftFrontMotorPower, double leftRearMotorPower, double righrRearMotorPower, double righrFrontMotorPower, double motorPower0, double motorPower1, double motorPower2, double motorPower3, double motorsScale, DcMotorEx leftFront, DcMotorEx leftRear, DcMotorEx rightFront, DcMotorEx rightRear, List<DcMotorEx> motors, VoltageSensor voltageSensor) {
        MotorPower0 = motorPower0;
        MotorPower1 = motorPower1;
        MotorPower2 = motorPower2;
        MotorPower3 = motorPower3;
        MotorsScale = motorsScale;
    ...
    public double[] calculateDrive(Vector correctivePower, Vector headingPower, Vector pathingPower, double robotHeading) {
        ...
        wheelPowers[0] *= MotorPower0;
        wheelPowers[1] *= MotorPower1;
        wheelPowers[2] *= MotorPower2;
        wheelPowers[3] *= MotorPower3;
