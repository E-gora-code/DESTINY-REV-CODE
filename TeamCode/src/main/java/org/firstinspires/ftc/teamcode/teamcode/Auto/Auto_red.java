...
public class Auto_red extends OpMode {
    ...
    private final Pose startPose = new Pose(0, 60, Math.toRadians(90)); // Facing -90 degrees (down)
    private final Pose chekPose1 = new Pose(7,124,Math.toRadians(90));
    private final Pose chekPose2 = new Pose(28,124,Math.toRadians(90));
    private final Pose chekPose3 = new Pose(52,120,Math.toRadians(90));
    private final Pose apple= new Pose(19.412, 62.961,Math.toRadians(180));
    private final Pose factory= new Pose(21.419, 35.805, Math.toRadians(270));
    ...
    private void buildPaths() {
        ...
        movetoap1 = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                new Point(chekPose1),
                                new Point(9.227, 59.973, Point.CARTESIAN),
                                new Point(apple)
                        )
                )
                .setLinearHeadingInterpolation(
        ...
        moveToScore3 = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                new Point(startPose),
                                new Point(3.130, 105.446, Point.CARTESIAN),
                                new Point(56.130, 109.446, Point.CARTESIAN),
                                new Point(chekPose3)
                        )
                )
                .setLinearHeadingInterpolation(
        ...
        movetoap3 = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                new Point(chekPose3),
                                new Point(0, 100.849, Point.CARTESIAN),
                                new Point(0, 67.849, Point.CARTESIAN),
                                new Point(apple)
                        )
                )
                .setLinearHeadingInterpolation(
        ...
        moveToScoreg3 = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                new Point(factory),
                                new Point(3.130, 105.446, Point.CARTESIAN),
                                new Point(55.130, 106.446, Point.CARTESIAN),
                                new Point(chekPose3)
                        )
                )
                .setLinearHeadingInterpolation(
