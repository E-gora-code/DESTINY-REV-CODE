...
public abstract class OpModeFramework extends LinearOpMode {
    ...
    protected RobotHardware.Motors.BasicCRServo spindexer, spindexer1,turret_x, barabim1, barabim2;
    ...
    public void selfInit(){
        ...
        spindexer1 = motors.new BasicCRServo(motors, RobotHardware.Motors.NameKeys.servoNameKeys.spindexer1);
